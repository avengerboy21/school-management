...
<html>
<head>
 <title>student_update_form</title>
 <style type="text/css">
...
// Connect to server and select databse.
          $con = mysqli_connect($host, $username, $password, $db_name);
            ...
            $query  = "SELECT * FROM student s
                   INNER JOIN account a ON s.sid=a.sid
                   INNER JOIN  parent p ON s.sid=p.sid
                   WHERE s.sid='$msgid'";
            //echo $query;
    ...
    <input type="text" placeholder="Enter your name" name="name" value="<?php echo $name?>" required><br>

  <label for="studentID"><b>Student ID :</b></label>
  <input type="number" placeholder="Enter student ID" name="sid" value="<?php echo $msgid?>" required><br>
  ...
  <input type="radio" name="Gender" <?php if($gender == 'f'){echo "checked=checked";}?>value="f">Female<br>
  ...
  <label for="address"><b>Address :</b></label>
    <input type="text" placeholder="Enter your address" name="address"  value="<?php echo $address?>" required><br>
  
  <label ><b>parent name : </b></label>
    <input type="text" placeholder="Enter parent's name" name="pname" value="<?php echo $pname?>" required><br>
  <label for="father_contact1"><b>parent contact no : </b></label>
    <input type="number" placeholder="Enter parent no." name="pcontact" value="<?php echo $contact?>" required><br>
  
 
  
  <label for="billno"><b>Bill no : </b></label>
    <input type="number" placeholder="Enter bill no." name="billno" value="<?php echo $billno?>" required><br>
  
  <label for="dop"><b>Date of payment : </b></label>
    <input type="text" placeholder="yyyy/mm/dd" name="dop" value="<?php echo $dop?>" required><br>
  
  <label for="attendance"><b>Attendance :</b></label>
    <input type="number" placeholder="attendance" name="attendance" value="<?php echo $attendance?>" required><br>
