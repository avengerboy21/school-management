...
<html>
<head>
 <title>admin_panel_students_entry</title>
                  ...
                  while ($row = mysqli_fetch_array($result2, MYSQLI_ASSOC)) {
                      ...
                      if (mysqli_affected_rows($conn) == 1) {
                          while ($row1 = mysqli_fetch_array($result4, MYSQLI_ASSOC)) {
                              ...
                              echo "<td><form action='student_update.php' method='post'><input type='hidden'  name='name' value='" . $sid . "'/><input type='submit' class='a1-btn a1-green' id='button1' value='Edit' class='btn btn-warning'/></form><form action='del_student.php' method='post' onsubmit='return ConfirmDelete()'><input type='hidden' name='name' value='" . $sid . "'/><input type='submit' value='Delete' width='20px' id='button1' class='a1-btn a1-orange'/></form></td></tr>";
